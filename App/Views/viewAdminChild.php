...
<div class="container">
  <div class="section">
    <div class="row center">
      <h4 class="deep-orange-text text-lighten-2">Modifiez les informations:</h4>
    ...
    <form class="col s12" action="index.php?action=updateChild" method="post">
      ...
      <div class="row">
        ...
        <div class="range-field col s6">
          <label for="height">Taille: <?= $child['height'] ?> (cm)</label>
          <input id="height" name="height" type="range" min="30" max="150" value="<?= $child['height'] ?>" required />
        </div>
        <!-- Poids -->
        <div class="range-field col s6">
          <label for="weight">Poids: <?= $child['weight'] ?> (kg)</label>
          <input id="weight" name="weight" type="range" min="0" max="25" step="0.01" value="<?= $child['weight'] ?>" required />
        </div>
      </div>
